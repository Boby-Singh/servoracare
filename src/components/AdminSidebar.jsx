...
function AdminSidebar() {
  ...
  return (
    <aside className="w-72 min-h-screen bg-gradient-to-b from-blue-950 via-blue-900 to-blue-950 text-white flex flex-col shadow-2xl">
      ...
      <div className="px-5 pt-6">
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-blue-800/40 border border-blue-700/40">
      ...
      <nav className="flex-1 px-4 pt-7">
        ...
        <p className="px-3 mb-3 text-[11px] font-semibold uppercase tracking-widest text-blue-400">
          Management
        </p>
      ...
      <div className="p-4 border-t border-blue-800/60">
        ...
        <button
          className="
            ...
            rounded-xl text-blue-200
            hover:bg-red-500/10 hover:text-red-300
            transition-all duration-200
          "
        >

          <div className="w-9 h-9 rounded-lg bg-blue-800/60 flex items-center justify-center">
